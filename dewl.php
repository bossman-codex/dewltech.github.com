...
<nav class="navbar navbar-expand-lg navbar-light ">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto" id="idnav">
      <li class="nav-item">
  ...
  <div class="row services">
    <div class="col-md-3 text-center">
      <div class="icon">
        ...
        <p>lsdkfjgfkdslkdjfgfkdsldkfjgfkdlskdjfgfkdls</p>
    </div>
    <div class="col-md-3 text-center">
      <div class="icon">
...
<section id="team">
  ...
  <div class="row">
      <div class="col-md-3 profile-pic text-center">
        ...
        <h2>fhdjs</h2>
        <h3>hsjakaa</h3> 
        <p>fghjkjhcvhjkjhgfghjkjhghjkjhg</p>
    </div>
    <div class="col-md-3 profile-pic text-center">
         <div class="img-box">
          <img src="" class="img-responsive">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 contact-info">
        ...
        <div class="follow"><b>Email:</b><i class="fa fa-envelope-o"></i>dewl_tech@yahoo.com</div>
